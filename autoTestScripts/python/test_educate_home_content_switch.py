...
class TestEducateHomeContentSwitch(BaseTestCase):
    ...
    def test_action(self):
        print("TestEducateHomeContentSwitch is start")
        ...
        print("TestEducateHomeContentSwitch is end")


if __name__ == "__main__":
    d = u2.connect()  # 连接设备
    test = TestEducateHomeContentSwitch(d)  # 创建测试对象
    test.setup()  # 初始化
    test.test_case()  # 开始测试
